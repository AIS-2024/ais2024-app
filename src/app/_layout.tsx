  ...
  return (
      ...
      <Stack screenOptions={({route})=>({
        ...
        <Stack.Screen
          ...
          options={{ title: "コレクション",headerLeft:()=> false  }}
        />
        <Stack.Screen
          name="home/mailSelect"
          options={{ title: "メール問題選択",headerLeft:()=> false  }}
        />
        <Stack.Screen
          name="home/smsSelect"
          options={{ title: "SMS問題選択",headerLeft:()=> false  }}
        />
        <Stack.Screen
          name="home/question4/call"
          options={{ title: "電話問題",headerLeft:()=> false  }}
        />
