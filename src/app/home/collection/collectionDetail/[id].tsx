...
const data = [
  ...
  { title: "電話", text: "電話に応答してしまうと利用できる電話番号と相手に認識されることはもちろん、個人情報の流出のリストが高まります。", text2: "拒否を押したとしても電話番号を使用していることを相手に知られてしまうため、触らずに出ないことが大切です。" },
  ...
  { title: "受け取りスポット", text: "プロモーションコードなどの割引を受け取ることを謳い文句にフィッシングサイトに誘導されることがあります。", text2: "メールの文章は正規サイトの物がほぼコピーされており、ぱっと見で判断することは難しくなっています。メールのURLはクリックせずに公式サイトのメッセージセンターで確認するようにしましょう。" },
