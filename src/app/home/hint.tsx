...
const Hint = () => {
  const accordionItems = [
    ...
    { title: "メール問題の解き方", detail: "問題画面のメールからフィッシング詐欺と見抜ける要素を探します。右下のボタンを押すと解答画面になるのでフィッシング詐欺の要素を直接タッチ！無ければ右下の「間違いなし」を選択してください。" },
    { title: "SMS問題の解き方", detail: "問題画面のSMSからフィッシング詐欺と見抜ける要素を探します。右下のボタンを押すと解答画面になるのでフィッシング詐欺の要素を直接タッチ！無ければ右下の「間違いなし」を選択してください。" },
    { title: "電話問題の解き方", detail: "電話アプリを開くと着信画面になるので、電話に出てください。問題画面のメールに遷移します。そこからフィッシング詐欺と見抜ける要素を探します。右下のボタンを押すと解答画面になるのでフィッシング詐欺の要素を直接タッチ！無ければ右下の「間違いなし」を選択してください。" },
