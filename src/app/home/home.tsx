...
const Home = () => {
  ...
  const [arrowPositionChange,setArrowPositionChange]=useState<boolean>(false);
        ...
        <View style={styles.modalOverlay}>
          ...
          <View style={styles.dialog}>
            ...
            <TouchableOpacity
              ...
              onPress={nextStep}
            >
            {step>=4?<Text style={styles.closeButtonText}>閉じる</Text>:<Text style={styles.closeButtonText}>次へ</Text>}
            </TouchableOpacity>
          </View>
        </View>
      </Modal>
